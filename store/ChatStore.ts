...
import Modal from "../src/pages/chats/components/modal/modal";
import HeaderContact from "../src/pages/chats/components/right-column/components/header/components/header-contact/header-contact";
import Menu from "../src/pages/chats/components/right-column/components/header/components/menu/menu";
import Header from "../src/pages/chats/components/right-column/components/header/header";
